...
- [ ] Ресурсы:
    - [x] [Курс: Bash: Основы командной строки (Hexlet)](https://ru.hexlet.io/courses/bash)
    - [x] [Статья: Искусство командной строки (статья)](https://github.com/jlevy/the-art-of-command-line/blob/master/README-ru.md)
    - [x] [Статья: Руководство по установке Debian GNU/Linux](https://www.debian.org/releases/stable/i386/index.html.ru)
...
- [x] Книга:
    - [x] [Pro Git (Scott Chacon, Ben Straub)](https://git-scm.com/book/ru/v2)
...
- [x] Курс:
    - [x] [Протокол HTTP (Hexlet)](https://ru.hexlet.io/courses/http_protocol)
